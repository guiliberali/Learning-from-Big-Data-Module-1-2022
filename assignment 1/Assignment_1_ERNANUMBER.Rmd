...
These two functions, Compute_posterior_sentiment and Compute_posterior_content, are called one time per review. These functions use the Bayes rule we saw in our session #2 to compute the posterior probabilities that the review is about each topic (in the first function) and  the posterior probability that the sentiment in the review is positive and/or negative (in the second function).
````{r, support functions}
