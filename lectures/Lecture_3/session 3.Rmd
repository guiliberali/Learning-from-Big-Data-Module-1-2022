...
likelihoods <- read.csv2("../data/likelihoods/example_100_fake_likelihood_topic.csv", 
...
Tip: for the data splits, mind the time. Best to train on a split that temporarily precedes the prediction split 
...
posteriors_w2v = matrix(0, nc=TOT_TOPICS_WORD2VEC, nr=TOT_REVIEWS)
